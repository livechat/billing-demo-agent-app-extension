An example LiveChat [Agent App Widget](https://developers.livechatinc.com/docs/agent-app-widgets/) using [LiveChat Billing API](https://docs.livechatinc.com/billing-api) to offer in-app payment.
